...
import MatrixRotator from '@/app/page'
import {
  EMPTY_MATRIX,
...
describe('when user visits the matrix rotator page', () => {
  it('should render the title', () => {
    renderWithMatrixProvider({ children: <MatrixRotator /> })
  ...
  it('loading state should be displayed when user types a valid 4x4 matrix', async () => {
    renderWithMatrixProvider({ children: <MatrixRotator /> })
